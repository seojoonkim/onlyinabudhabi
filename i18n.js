...
const i18n = {
    ko: {
        ...
        aboutDesc: "아부다비 문화관광청(DCT Abu Dhabi)이 엄선한 101개의 특별한 즐길거리에 대해, 10만개 이상의 후기 데이터 분석을 통해 쉽게 찾아볼 수 있도록 정리했습니다.",
        categoryAll: "전체 카테고리",
        landmark: "명소/랜드마크",
        themepark: "테마파크",
        dining: "다이닝",
        ...
        aboutModalStory: "이 프로젝트는 서울에서 아부다비로 가는 에티하드 항공 기내에서 시작되었습니다. 기내 스크린에서 아부다비 문화관광청의 \"101가지 즐길거리\" 영상을 보고 온라인에서 가이드를 찾아보았지만, 웹사이트의 사용성이 너무 떨어졌습니다. 비행기 안에서 바로 노트북을 열고 onlyinabu.com 도메인을 구입한 뒤, Claude와 함께 재구성 작업을 시작했습니다. 출장 3일동안 구글맵에서 10만개 이상의 리뷰를 크롤링하고 분석하여, 원본 데이터를 체계적이고 사용하기 편리한 플랫폼으로 완성했습니다. 폰트와 색상 테마는 프로젝트에 영감을 준 에티하드 항공 웹사이트에서 벤치마킹했습니다.",
    ...
    en: {
        ...
        aboutDesc: "101 unique experiences curated by DCT Abu Dhabi, organized for easy discovery through analysis of over 100,000 authentic visitor reviews.",
    ...
    ar: {
        ...
        aboutDesc: "101 تجربة فريدة اختارتها هيئة أبوظبي للسياحة، منظمة لسهولة الاكتشاف من خلال تحليل أكثر من 100,000 مراجعة حقيقية.",
        ...
        aboutModalStory: "ولد هذا المشروع على متن رحلة طيران الاتحاد من سيول إلى أبوظبي. بعد مشاهدة الفيديو الترويجي على متن الطائرة حول \"101 شيء للقيام به\" من هيئة أبوظبي للسياحة، بحثت عن الدليل عبر الإنترنت - لأجد أن موقع الويب صعب التصفح والاستكشاف. هناك على متن الطائرة، فتحت الكمبيوتر المحمول، اشتريت نطاق onlyinabu.com، وبدأت في بناء هذه النسخة المعاد تصميمها مع Claude. على مدى ثلاثة أيام خلال رحلة العمل، أكملت النسخة الأولية من خلال جمع وتحليل أكثر من 100,000 مراجعة من خرائط جوجل، محولاً البيانات الأولية إلى منصة منظمة وسهلة الاستخدام. تم اقتباس الخطوط والألوان من موقع طيران الاتحاد الذي ألهم هذا المشروع.",
    ...
    ja: {
        ...
        aboutDesc: "DCTアブダビが厳選した101の特別な体験について、100,000件以上の実際の訪問者レビューを分析し、簡単に見つけられるよう整理しました。",
        categoryAll: "全カテゴリ",
        landmark: "ランドマーク",
        themepark: "テーマパーク",
        dining: "ダイニング",
        ...
        aboutModalStory: "このプロジェクトは、ソウルからアブダビへのエティハド航空機内で生まれました。機内スクリーンでアブダビ文化観光局の「101のやるべきこと」のプロモーション動画を見た後、オンラインでガイドを検索しましたが、ウェブサイトのナビゲーションが非常に困難でした。飛行機の中で直ちにノートパソコンを開き、onlyinabu.comドメインを購入した後、Claudeと共にこの再設計版の構築を始めました。出張中の3日間で、Googleマップから10万件以上のレビューをクロールして分析し、生データを整理された使いやすいプラットフォームに変換して初版を完成させました。フォントとカラーテーマは、このプロジェクトに影響を与えたエティハド航空のウェブサイトをベンチマークしました。",
    ...
    zh: {
        ...
        aboutDesc: "由阿布扎比旅游局(DCT Abu Dhabi)精选的101个特别体验，通过分析超过100,000条真实游客评论，整理为便于发现的格式。",
        categoryAll: "全部类别",
        landmark: "地标",
        themepark: "主题公园",
        dining: "餐饮",
        ...
        aboutModalStory: "这个项目诞生于从首尔飞往阿布扎比的阿提哈德航空航班上。在观看机上宣传视频介绍阿布扎比旅游局的「101件必做之事」后，我在线搜索了该指南——却发现网站难以浏览和探索。就在飞机上，我打开笔记本电脑，购买了onlyinabu.com域名，并开始与Claude一起构建这个重新设计的版本。在出差期间的三天内，通过爬取和分析超过10万条谷歌地图评论，我完成了初始版本，将原始数据转化为一个有序、用户友好的平台。字体和配色方案参考了启发本项目的阿提哈德航空网站。",
